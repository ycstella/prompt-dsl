...
func GeneratepromptCode(root *PromptNode, pkgName string, eval *final, filename string, goimport []goimport) string {
	...
	b.WriteString("    log.Println(os.Stderr, \"[main] 程序启动，等待输入...\")\n")
	...
	if strings.TrimSpace(root.BeforeCode[0]) != "" {
		...
		b.WriteString("    if err!=nil {\n")
		b.WriteString("    \tlog.Println(os.Stderr, \"预处理失败 %v\", err)\n")
	...
	b.WriteString("        if err != nil {\n")
	b.WriteString("            log.Println(os.Stderr, \"调用大模型失败: %v\\n\", err)\n")
	b.WriteString("            os.Exit(1)\n")
	b.WriteString("        }\n")
	...
	if len(root.OutFields) > 0 {
		...
		b.WriteString("        if err != nil {\n")
		b.WriteString("            log.Println(os.Stderr, \"解析输入 JSON 失败011111: %v\\n\", err)\n")
		b.WriteString("            os.Exit(1)\n")
		b.WriteString("        }\n")
		b.WriteString("        final := prompt.AfterProcess(" + outname + ")\n")
		b.WriteString("        encoded, err := json.Marshal(final)\n")
		b.WriteString("        if err != nil {\n")
		b.WriteString("            log.Println(os.Stderr, \"输出编码失败: %v\\n\", err)\n")
		b.WriteString("            os.Exit(1)\n")
		b.WriteString("        }\n")
		b.WriteString("        log.Println(string(encoded))\n")
...
func writeMain(b *strings.Builder, filename string) {
	...
	b.WriteString("    }\n")
	b.WriteString("    log.Println(\"config目录\", os.Args[2])\n")
	b.WriteString("    log.Println(\"input路径\", os.Args[3])\n")
	b.WriteString("    config.InitConfig(os.Args[2])\n")
	b.WriteString("    config.InitLogger()\n\n")
	b.WriteString("    // 读取输入文件\n")
	b.WriteString("    inputfile := os.Args[3]\n")
	...
	b.WriteString("    }\n\n")
	b.WriteString("    modelname:=os.Args[1]\n")
